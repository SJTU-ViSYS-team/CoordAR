...
if __name__ == "__main__":
    ...
    parser.add_argument("obj_pose", nargs="?", help="Path to the pose file")
    parser.add_argument("intrinsics", nargs="?", help="Path to the intrinsics file")
    parser.add_argument(
